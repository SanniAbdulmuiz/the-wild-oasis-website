...
export const getCabins = async function () {
  ...
  //console.log("Fetched cabins:", data); // ✅ Check if new data appears here
  //console.error("Fetch error:", error); // 🚨 See if there's an error
...
export async function getCabinCount() {
  //Get cabin count only
  const { count, error } = await supabase
    .from("cabins")
    .select("*", { count: "exact", head: true }); // Get count only

  if (error) {
    console.error("Error fetching cabin count:", error);
